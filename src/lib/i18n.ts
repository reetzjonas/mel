...
const en = {
  ...
  'sync.failed.one': '1 change could not be sent — see the browser console',
  'sync.failed.many': 'changes could not be sent — see the browser console',
...
const de: Partial<Record<MsgKey, string>> = {
  ...
  'sync.failed.one': '1 Änderung konnte nicht übertragen werden — siehe Browser-Konsole',
  'sync.failed.many': 'Änderungen konnten nicht übertragen werden — siehe Browser-Konsole',
