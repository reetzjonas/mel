...
export const inputClass =
  'min-h-11 w-full rounded-control border border-line bg-canvas px-3 py-2 text-sm outline-none transition-[border-color,box-shadow] focus:border-accent focus:ring-2 focus:ring-accent/25 sm:min-h-0'
