...
const paths: Record<string, string> = {
  ...
  draft: 'M12 20h9M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z',
  ...
  file: 'M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Zm0 0v5h5',
  filter: 'M3 5h18l-7 8v6l-4 2v-8L3 5Z',
  upload: 'M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 9l5-5 5 5m-5-5v12',
  ...
  flagOff: 'M4 22V4c0-.6.4-1 1-1h9.5a1 1 0 0 1 .8 1.6L13 8l2.3 3.4a1 1 0 0 1-.8 1.6H4M2 2l20 20',
  mailUnread:
  ...
  copy: 'M20 8h-8a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V10a2 2 0 0 0-2-2ZM6 16H5a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1',
  folderPlus:
  ...
  home: 'm3 10 9-7 9 7v10a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1Zm6 11v-6h6v6',
  image: 'M3 3h18v18H3Zm0 14 5-5 4 4 3-3 6 6M8.5 8.5h.01',
  music: 'M9 18V5l10-2v13M9 18a3 3 0 1 1-2-3 3 3 0 0 1 2 3Zm10-2a3 3 0 1 1-2-3 3 3 0 0 1 2 3Z',
  video: 'm15 10 4.5-2.5v9L15 14ZM3 6h12v12H3Z',
  lock: 'M7 11V7a5 5 0 0 1 10 0v4m-12 0h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-8a1 1 0 0 1 1-1Z',
  check: 'M20 6 9 17l-5-5',
  key: 'M15.5 7.5 19 4m2-2-9.6 9.6m0 0a5.5 5.5 0 1 1-7.78 7.78 5.5 5.5 0 0 1 7.78-7.78Zm4.1-4.1L18 8l3-3-2.5-2.5',
  ...
  quoteCode: 'm16 18 6-6-6-6M8 6l-6 6 6 6',
