  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        'src/providers/**': { statements: 73, branches: 70, functions: 69, lines: 72 },
        'src/sync/**': { statements: 79, branches: 69, functions: 78, lines: 83 },
        'src/services/**': { statements: 72, branches: 63, functions: 72, lines: 73 },
      },
    },
  },
})
