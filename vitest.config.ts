  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        'src/providers/**': { statements: 96, branches: 86, functions: 92, lines: 96 },
        'src/sync/**': { statements: 93, branches: 85, functions: 86, lines: 95 },
        'src/services/**': { statements: 93, branches: 84, functions: 91, lines: 96 },
      },
    },
  },
})
